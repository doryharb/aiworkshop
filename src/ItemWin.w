...
DO:
  ...
  lFound = objItemEntity:GetItemByNumber(FILL-IN_ItemNum, OUTPUT DATASET dsItem).
...
DO:
  ...
  DO:
     ...
     /* Validate using the entity */
     isValid = objItemEntity:ValidateItem(DATASET dsItem, OUTPUT cErrorMessage).
     
     IF isValid THEN
     DO:
        objItemEntity:UpdateItem(DATASET dsItem).
     END.
     ELSE
     DO:
